...
Welcome to the master repository for my **Hack-o-Week** submissions! This repository showcases a diverse collection of four distinct projects that span across **Natural Language Processing (NLP)**, **Embedded Systems & IoT Simulations**, and **Full-Stack AI Web Development**. 
